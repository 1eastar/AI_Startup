              ...
              />*/}
                <Header style={styles.header}>
                    <Left>
                        <TouchableOpacity
                            onPress={() => {
                                this.props.navigation.navigate('TestExplain')
                            }}
                            style={{marginLeft: 10}}>
                            <Ionicons name='ios-arrow-back' size={30} color={'#fff'}/>
                        </TouchableOpacity>
                    </Left>
                    <Body><Text style={{color: 'white', fontSize: 20, marginLeft: 20, width: 200}}> 남은
                        시간 {Math.floor(this.state.timelimit / 60)}:{this.state.timelimit - Math.floor(this.state.timelimit / 60) * 60}</Text></Body>
                    <Right><Text style={{color: 'white', fontSize: 20, marginRight: 10}}>{this.state.problemNum} /
                        15</Text></Right>
                </Header>
                <Image source={{uri: this.state.problem.problemImage}} style={styles.problem} resizeMode={'contain'}/>
